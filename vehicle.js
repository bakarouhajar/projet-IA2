...
class Vehicle {
  ...
  */
  ...
  drawVehicle() {
    ...
    // Translation et rotation au niveau de la position du véhicule
    ...
    // Corps de l'oiseau
    ellipse(0, 0, this.r_pourDessin * 2, this.r_pourDessin);

    // Couleur aléatoire pour les ailes
    fill(random(255), random(255), random(255));
    ellipse(-this.r_pourDessin, 0, this.r_pourDessin, this.r_pourDessin * 1.5);

    // Couleur aléatoire pour la queue
    fill(random(255), random(255), random(255));
    triangle(
      this.r_pourDessin, 0,
      this.r_pourDessin * 2, -this.r_pourDessin / 2,
      this.r_pourDessin * 2, this.r_pourDessin / 2
    );
